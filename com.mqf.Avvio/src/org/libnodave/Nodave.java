...
public class Nodave
{
	...
	/*
	 * Use these constants for parameter "area" in daveReadBytes and
	 * daveWriteBytes
	 */
	...
	public final static int ANALOGOUTPUTS200 = 7; // analog outputs of 200
													// family
	...
	// Libnodave will pass the PDUs of S7 Communication to user defined call
	// back functions.
	 ...
	 * 
	 * @param text
	 *            : a text to print before the list
	 * @return
	 */
